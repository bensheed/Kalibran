...
CREATE VIEW kanban_cards_view AS
SELECT 
    id,
    Inst_ID,
    Job_no,
...
CREATE TABLE column_transitions (
    id SERIAL PRIMARY KEY,
...
CREATE INDEX idx_column_transitions_job_no ON column_transitions(job_no);
CREATE INDEX idx_raw_sync_data_inst_id ON raw_sync_data(Inst_ID);
CREATE INDEX idx_raw_sync_data_job_no ON raw_sync_data(Job_no);
